...
def logo():
	os.system("clear")
	print("""
\x1b[1;97m    _____            __        _____             
\x1b[1;97m   / __(_)_ _  ___  / /__ ____/ 
\x1b[1;97m  _\ \/ /  ' \/ _ \/ / -_)___/ 
\x1b[1;97m /___/_/_/_/_/ .__/_/\__/  
\x1b[1;97m            /_/     """)
...
def tokenz():
	...
	try:
		...
		logo()
		print""+p+""
		print" [+] Cara Ambil Token Bisa Cek Di https://youtu.be/HqoPExMgSYM"
		token = raw_input('\n [+] Masukkan Token : ')
		try:
...
def menu():
    ...
    logo()
    print(" "+p+"[*] Author     : BANG JONI GANTENG.") 
    print(" [*] Github     : https://github--------(JONI")
    print(" [*] ---------------------------------------------")
    print(" [*] ID         : "+id)
    print(" [*] IP         : "+ip)
    print"\n [ selamat datang MEMEK: \033[1;93m"+nama+"\033[1;97m ]"
    print("")
